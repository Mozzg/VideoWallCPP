...
void AsyncSerial::setReadCallback(const AsyncSerial::funcType& callback)
{
...
void CallbackAsyncSerial::setCallback(const AsyncSerial::funcType& callback)
{
